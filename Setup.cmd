...
if exist "%PYTHON_INSTALLER%" (
    ...
    python -m ensurepip --default-pip
    python -m pip install --upgrade pip
    pip install discord.py pillow mss opencv-python sounddevice numpy scipy pyautogui pynput screeninfo requests psutil pycaw comtypes pywin32 mss numpy scipy pyinstaller ImageGrab
    cls
    python build.py
) else (
